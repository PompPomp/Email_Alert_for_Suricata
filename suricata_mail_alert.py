...
def send_email(body, header, timedate):
    ...
    command = f'echo "A new attack detected at {timedate}: {message_log}" | mail -s "Suricata detected a {header} ' \
              f'attack" -a "From: suricata@terrasystems.com" jasonleeweekang@gmail.com '
